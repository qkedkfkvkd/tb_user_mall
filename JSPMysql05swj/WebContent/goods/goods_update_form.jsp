...
<%
	...
	try {
		...
		System.out.println(rs + " : rs   goods_update_form.jsp");
...
<table border="1">
	...
	<tr>
		<td>카테고리</td>
		<td><input type="text" name="g_cate" value="<%=dbcate%>"></td>
	</tr>
	<tr>
		<td>가격</td>
	...
	<tr>
		<td>색상</td>
		<td><input type="text" name="g_color" value="<%=dbcolor%>"></td>
	</tr>
	<tr>
		<td>사이즈</td>
		<td><input type="text" name="g_size" value="<%=dbsize%>"></td>
	</tr>
	<tr>
		<td>등록일</td>
